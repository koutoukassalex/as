...
const PLUGIN_NAME = 'llama-rn-plugin-local';
const PLUGIN_VERSION = '1.0.0';

const withLlamaRnLocal = (config, options = {}) => {
  const {
...
module.exports = createRunOncePlugin(withLlamaRnLocal, PLUGIN_NAME, PLUGIN_VERSION);
